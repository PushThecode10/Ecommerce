      ...
      <nav className={`ec-navbar ${scrolled ? "scrolled" : "top"}`}>
        <div className="ec-navbar-inner">
          ...
          <Link to="/" className="ec-logo">
            <img src={logo} alt="ECommerce" className="h-8 rounded-xl" />
            <span className="ec-logo-text">
              E<span className="ec-logo-dot">·</span>Commerce
            </span>
          </Link>
          ...
          <div className="ec-navlinks">
            {navLinks.map((l) => (
              <Link
                key={l.to}
                to={l.to}
                className={`ec-navlink ${isActive(l.to) ? "active" : ""}`}
              >
                {l.icon}
                {l.label}
              </Link>
          ...
          <div className="ec-nav-right">
            ...
            <Link
              to="/cart"
              className={`ec-icon-btn ${cartPop ? "cart-bounce-anim" : ""}`}
            >
            ...
            {isAuthenticated ? (
              ...
              <>
                <Link to="/login" className="ec-btn-login">
                  Login
                </Link>
                <Link to="/register" className="ec-btn-signup">
                  Sign Up
                </Link>
              </>
            )}
          ...
          >
            ...
            {navLinks.map((l, i) => (
              ...
              >
                <Link
                  to={l.to}
                  className={`ec-mobile-link ${isActive(l.to) ? "active" : ""}`}
                >
                  {l.icon} {l.label}
                </Link>
              </motion.div>
    ...
    <footer className="ec-footer">
      ...
      <div
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg, transparent, rgba(124,58,237,.4), rgba(236,72,153,.3), transparent)",
        }}
      />
        ...
        <div className="ec-footer-grid">
          ...
          >
            ...
            >
              ...
              >
                E<span style={{ color: "#a78bfa" }}>·</span>Commerce
              </span>
            </Link>
            ...
            >
              ...
              secured by our buyer protection.
            </p>
            ...
            <AnimatePresence mode="wait">
              {subscribed ? (
                ...
                >
                  ...
                  />
                  <button type="submit" className="ec-newsletter-btn">
                    Subscribe
                  </button>
                </motion.form>
              )}
          ...
          {Object.entries(footerLinks).map(([section, links], si) => (
            ...
            >
              ...
              {links.map((l) => (
                <Link key={l.label} to={l.to} className="ec-footer-link">
                  {l.label}
                </Link>
              ))}
            </motion.div>
            ...
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map(
              (t) => (
                <a
                  ...
                  onMouseEnter={(e) =>
                    (e.target.style.color = "rgba(167,139,250,.7)")
                  }
                  onMouseLeave={(e) =>
                    (e.target.style.color = "rgba(255,255,255,.22)")
                  }
                >
                  {t}
                </a>
        ...
        {Array.from({ length: 18 }, (_, i) => (
          <div
            ...
            style={{
              ...
              animation: `float-up ${5 + (i % 5)}s ease-in-out ${i * 0.4}s infinite`,
            }}
          />
        ))}
